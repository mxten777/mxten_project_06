    ...
    <div className="space-y-6">
      ...
      <div className="card p-6 bg-gradient-to-br from-purple-50 to-white border border-purple-100">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="font-bold text-purple-700">QR코드 이미지 스캔</div>
        </div>
        <input 
          type="file" 
          accept="image/*"
      ...
      <div className="card p-6 bg-gradient-to-br from-blue-50 to-white border border-blue-100">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="font-bold text-blue-700">작업지시서 ID 직접 입력</div>
        </div>
      ...
      {/* 스캔 결과 표시 */}
      {result && (
        <div className="card p-6 bg-gradient-to-br from-green-50 to-white border border-green-100">
